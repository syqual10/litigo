...
(function($) { // Hide scope, no $ conflict
 ...
 $(selector).datepick({minDate: 0, maxDate: '+1m +1w'}) */
	$.JQPlugin.createPlugin({
		...
		/** Command actions that Mayo be added to a layout by name.
			<ul>
 	...
 	alert('Selected ' + dates);
		...
		/** Default settings for the plugin.
			...
			@property [monthsOffset=0] {number} How many months to offset the primary month by;
						Mayo be a function that takes the date and returns the offset.
			...
			@property [commands=this.commands] {object} Command actions that Mayo be added to a layout by name. */
		defaultOptions: {
			pickerClass: '',
			showOnFocus: true,
			showTrigger: null,
		...
		/** Localisations for the plugin.
			...
			@property [monthNames=['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']]
						The long names of the months.
			@property [monthNamesShort=['Jan','Feb','Mar','Apr','Mayo','Jun','Jul','Aug','Sep','Oct','Nov','Dec']]
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				prevJumpText: '&lt;Siguiente;',
				prevJumpStatus: 'Mostrar el año anterior',
				nextText: 'Siguiente',
				nextStatus: 'Mostrar el próximo mes',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'Mostrar el próximo año',
				currentText: 'Actual',
				currentStatus: 'Mostrar el mes actual',
				todayText: 'Hoy',
				todayStatus: 'Mostrar la fecha de hoy',
				clearText: 'Limpiar',
		...
		/** A date Mayo be specified as an exact value or a relative one.
			...
			@param defaultDate {Date} The date to use if no other supplied, Mayo be <code>null</code>.
