        ...
        return e.addDeviceType = function() {
            ...
            var e = {
                userLogout: function(e) {
                    ...
                    $.SmartMessageBox({
                        title: "<i class='fa fa-sign-out txt-color-primary'></i> Cerrar Sesión <span class='txt-color-primary'><strong>" + $("#show-shortcut").text() + "</strong></span> ?",
                        content: e.data("logout-msg") || "Será desconectado de nuestros servidores",
                        buttons: "[No][Sí]"
