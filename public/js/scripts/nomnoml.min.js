! function(factoryFn) {
    "function" == typeof define && define.amd ? define(["lodash"], factoryFn) : "object" == typeof module && module.exports ? module.exports = factoryFn(require("lodash")) : this.nomnoml = factoryFn(_)
}(function(_) {
    ! function a(b, c, d) {
        function e(g, h) {
            if (!c[g]) {
        ...
        1: [function(a, b, c) {
            var d = "undefined" != typeof self ? self : "undefined" != typeof window ? window : {};
            d.dagre = a("./index")
        }, {
            "./index": 2
        }],
        ...
        3: [function(a, b, c) {
            ...
            b.exports = function() {
                ...
                function k(a) {
                    var h, g = i.rankSep();
                    try {
                        return h = d.time("initLayoutGraph", j)(a), 0 === h.order() ? h : (h.eachEdge(function(a, b, c, d) {
                            d.minLen *= 2
                    ...
                    a.eachEdge(function(c, d, e, f) {
                        ...
                        if (h > g + 1) {
                            for (var i = d, j = g + 1, k = 0; h > j; ++j, ++k) {
                                ...
                                0 === k ? m.index = 0 : j + 1 === h && (m.index = 1), a.addNode(l, m), a.addEdge(null, i, l, {}), i = l
                            }
        ...
        4: [function(a, b, c) {
            function k(a, b) {
                ...
                for (var k, i = 0, l = Number.MAX_VALUE, m = {}, p = 0; p < Number(c) + 1 && 0 !== l; ++p) {
                    k = Number.MAX_VALUE, g(a, c > 0), d.log(2, "Order phase start cross count: " + a.graph().orderInitCC);
                    var q, r, s;
                    for (q = 0, r = 0; 4 > r && b > q && k > 0; ++q, ++r, ++i) n(a, h, q), s = e(a), k > s && (r = 0, k = s, l > s && (o(), l = s)), d.log(3, "Order phase start " + p + " iter " + q + " cross count: " + s)
                }
                Object.keys(m).forEach(function(b) {
                    a.children && a.children(b).length || (a.node(b).order = m[b])
        ...
        5: [function(a, b, c) {
            function e(a) {
                for (var b = 0, c = d.ordering(a), e = 1; e < c.length; ++e) b += f(a, c[e - 1], c[e]);
                return b
            }
            ...
            function f(a, b, c) {
                ...
                for (var e = 1; e < c.length;) e <<= 1;
                var f = 2 * e - 1;
                e -= 1;
                for (var g = [], h = 0; f > h; ++h) g[h] = 0;
                var i = 0;
                return d.forEach(function(a) {
                    var b = a + e;
                    for (++g[b]; b > 0;) b % 2 && (i += g[b + 1]), b = b - 1 >> 1, ++g[b]
                }), i
            }
            var d = a("../util");
            b.exports = e
        ...
        6: [function(a, b, c) {
            function f(a) {
                function c(d) {
                    if (null === d) return void a.children(d).forEach(function(a) {
                        c(a)
                    });
                    var f = a.node(d);
        ...
        7: [function(a, b, c) {
            function f(a, b) {
                ...
                a.eachNode(function(b, d) {
                    var e = c[d.rank];
                    a.children && a.children(b).length > 0 || (e || (e = c[d.rank] = []), e.push(b))
        ...
        8: [function(a, b, c) {
            function e(a, b, c) {
                ...
                for (var h = 0, i = 0, j = g.length; j > i; ++h) void 0 !== f[e[h]] && (a.node(g[i++]).order = h)
            }
            var d = a("../util");
            b.exports = e
        }, {
        ...
        9: [function(a, b, c) {
            ...
            b.exports = function() {
                function c(b) {
                    ...
                    ["u", "d"].forEach(function(d) {
                        "d" === d && c.reverse(), ["l", "r"].forEach(function(f) {
                            "r" === f && m(c);
                            var j = d + f,
                                k = g(b, c, e, "u" === d ? "predecessors" : "successors");
                            i[j] = h(b, c, k.pos, k.root, k.align), a.debugLevel >= 3 && t(d + f, b, c, i[j]), "r" === f && l(i[j]), "r" === f && m(c)
                        }), "d" === d && c.reverse()
                    ...
                    var j = 0,
                        p = "BT" === b.graph().rankDir || "RL" === b.graph().rankDir;
                    c.forEach(function(c) {
                ...
                function e(a, b) {
                    return b > a ? a.toString().length + ":" + a + "-" + b : b.toString().length + ":" + b + "-" + a
                }
                ...
                function f(a, b) {
                    ...
                    for (var l = 1; l < b.length - 1; ++l) {
                        ...
                        for (var m = 0; m < g.length; ++m) {
                            var n = g[m];
                            if (d[n] = m, j = void 0, a.node(n).dummy) {
                                var o = a.predecessors(n)[0];
                                void 0 !== o && a.node(o).dummy && (j = d[o])
                            }
                            if (void 0 === j && m === g.length - 1 && (j = f.length - 1), void 0 !== j) {
                                for (; m >= i; ++i) a.predecessors(g[i]).forEach(k);
                                h = j
                            }
                        }
                    }
                ...
                function p(b, c) {
                    if (null !== a.universalSep) return a.universalSep;
                    var d = n(b, c),
                ...
                function q(a, b, c) {
                    if ("LR" === a.graph().rankDir || "RL" === a.graph().rankDir) {
                ...
                function r(a, b, c, d) {
                    if ("LR" === b.graph().rankDir || "RL" === b.graph().rankDir) {
                ...
                function t(a, b, c, d) {
                    c.forEach(function(c, e) {
                        ...
                        c.forEach(function(c) {
                            ...
                            if (f) {
                                var i = p(b, f) + p(b, c);
                                i > h - g && console.log("Position phase: sep violation. Align: " + a + ". Layer: " + e + ". U: " + f + " V: " + c + ". Actual sep: " + (h - g) + " Expected sep: " + i)
                            }
                            f = c, g = h
                        })
                    })
        ...
        11: [function(a, b, c) {
            function e(a) {
                function f(d) {
                    d in c || (c[d] = b[d] = !0, a.outEdges(d).forEach(function(c) {
                        var i, h = a.target(c);
        ...
        12: [function(a, b, c) {
            function d(a) {
                return "min" !== a && "max" !== a && 0 !== a.indexOf("same_") ? (console.error("Unsupported rank type: " + a), !1) : !0
            }
            ...
            function g(a, b, c) {
                void 0 !== c && a.children(b).forEach(function(b) {
            ...
            c.apply = function(a) {
                function b(c) {
                    ...
                    a.children(c).forEach(function(g) {
                        if (a.children(g).length) return void b(g);
                        var h = a.node(g),
                            j = h.prefRank;
                        if (void 0 !== j) {
                            if (!d(j)) return;
                            ...
                            var k = i[j];
                            void 0 === k && (k = i[j] = a.addNode(null, {
                                originalNodes: []
                            }), a.parent(k, c)), e(a, g, k, "min" === j), f(a, g, k, "max" === j), a.node(k).originalNodes.push({
                                u: g,
                                value: h,
                                parent: c
                            }), a.delNode(g)
        ...
        13: [function(a, b, c) {
            function g(a) {
                ...
                for (; b.size();) {
                    for (var j = c.order() ? c.nodes() : b.keys(), k = 0, l = j.length; l > k && g(j[k]); ++k);
                    b.size() && i()
                }
                return c
            }
        ...
        14: [function(a, b, c) {
            function f(a) {
                ...
                b.forEach(function(b) {
                    var c = a.inEdges(b);
                    if (0 === c.length) return void(a.node(b).rank = 0);
        ...
        16: [function(a, b, c) {
            ...
            function l(a, b, c) {
                ...
                if (h ? a.eachEdge(function(d, f, h, l) {
            ...
            function m(a, b, c, d) {
                ...
                var e = a.source(d),
                    f = a.target(d);
                h(f);
                for (var i = e, j = b.inEdges(i); j.length > 0;) i = b.source(j[0]), j = b.inEdges(i);
            ...
            function o(a, b, c) {
                ...
                var f = a.inEdges(b, c);
                return f.length > 0 ? -d.max(f.map(function(b) {
                    return a.edge(b).minLen
                })) : void 0
            }
            var d = a("../util"),
        ...
        20: [function(a, b, c) {
            ...
            b.exports = d, d.prototype.size = function() {
                ...
                for (var d, b = this._arr, c = b[a].priority; 0 !== a && (d = a >> 1, !(b[d].priority < c));) this._swap(a, d), a = d
        ...
        21: [function(a, b, c) {
            ...
            b.exports = e, e.intersect = function(a) {
                if (0 === a.length) return new e;
                for (var b = new e(d.isArray(a[0]) ? a[0] : a[0].keys()), c = 1, f = a.length; f > c; ++c)
                    for (var g = b.keys(), h = d.isArray(a[c]) ? new e(a[c]) : a[c], i = 0, j = g.length; j > i; ++i) {
                        var k = g[i];
                        h.has(k) || b.remove(k)
                    }
                return b
            }, e.union = function(a) {
                for (var b = d.reduce(a, function(a, b) {
                        return a + (b.size ? b.size() : b.length)
                    }, 0), c = new Array(b), f = 0, g = 0, h = a.length; h > g; ++g)
                    for (var i = a[g], j = d.isArray(i) ? i : i.keys(), k = 0, l = j.length; l > k; ++k) c[f++] = j[k];
                return new e(c)
        ...
        22: [function(a, b, c) {
            Array.isArray ? c.isArray = Array.isArray : c.isArray = function(a) {
                ...
                var d, e, f = a.length >>> 0,
                    g = !1;
                for (1 < arguments.length && (e = c, g = !0), d = 0; f > d; ++d) a.hasOwnProperty(d) && (g ? e = b(e, a[d], d, a) : (e = a[d], g = !0));
        ...
        25: [function(a, b, c) {
            ...
            b.exports = e, e.prototype.order = function() {
                ...
                if (this._strictGetNode(b), this._strictGetNode(c), void 0 === a || null === a) {
                ...
                var b = this._nodes[a];
                if (void 0 === b) throw new Error("Node '" + a + "' is not in graph");
                return b
            }, e.prototype._strictGetEdge = function(a) {
                var b = this._edges[a];
                if (void 0 === b) throw new Error("Edge '" + a + "' is not in graph");
                return b
            }
        }, {
            "cp-data": 19
        ...
        26: [function(a, b, c) {
            ...
            b.exports = f, f.fromDigraph = function(a) {
                var b = new f,
                    c = a.graph();
                return void 0 !== c && b.graph(c), a.eachNode(function(a, c) {
            ...
            function e(a, b, c, e) {
                function h(b) {
                    var d = a.incidentNodes(b),
                        ...
                        k = c(b),
                        l = j.distance + k;
                    if (0 > k) throw new Error("dijkstra does not allow negative edge weights. Bad edge: " + b + " Weight: " + k);
                ...
                for (var i, j; g.size() > 0 && (i = g.removeMin(), j = f[i], j.distance !== Number.POSITIVE_INFINITY);) e(i).forEach(h);
                return f
            }
        ...
        38: [function(a, b, c) {
            function f(a, b) {
                function i(c) {
                    ...
                    if (void 0 !== i) {
                        var j = b(c);
                        i > j && (f[e] = h, g.decrease(e, j))
                    }
                }
                var h, c = new d,
                    f = {},
                    g = new e;
                if (0 === a.order()) return c;
                a.eachNode(function(a) {
                    g.add(a, Number.POSITIVE_INFINITY), c.addNode(a)
                }), g.decrease(a.nodes()[0], 0);
                for (var j = !1; g.size() > 0;) {
                    if (h = g.removeMin(), h in f) c.addEdge(null, h, f[h]);
                    else {
        ...
        39: [function(a, b, c) {
            function d(a) {
                function f(h) {
                    ...
                    if (c.push(h), a.successors(h).forEach(function(a) {
        ...
        40: [function(a, b, c) {
            function d(a) {
                ...
                var b = {},
                    ...
                    d = [],
                    g = a.sinks();
                if (0 !== a.order() && 0 === g.length) throw new e;
        ...
        41: [function(a, b, c) {
            function e(a) {
                ...
                return b.prototype = new a, b.prototype.constructor = b, b.prototype.parent = function(a, b) {
                    if (this._strictGetNode(a), arguments.length < 2) return this._parents[a];
                    if (a === b) throw new Error("Cannot make " + a + " a parent of itself");
                    null !== b && this._strictGetNode(b), this._children[this._parents[a]].remove(a), this._parents[a] = b, this._children[b].add(a)
                }, b.prototype.children = function(a) {
                    return null !== a && this._strictGetNode(a), this._children[a].keys()
                    ...
                    function f(a) {
                        var b = c.parent(a);
                        return null === b || d.hasNode(b) ? (e[a] = b, b) : b in e ? e[b] : f(b)
                    }
                    var c = this,
        ...
        42: [function(a, b, c) {
            ...
            c.decode = function(a, b, c) {
                if (c = c || e, "Array" !== h(a)) throw new Error("nodes is not an Array");
                if ("Array" !== h(b)) throw new Error("edges is not an Array");
                ...
                if (a instanceof g) h = "cdigraph";
                    ...
                    if (!(a instanceof d)) throw new Error("Couldn't determine type of graph: " + a);
                    h = "graph"
                }
                return {
                    nodes: b,
    ...
    skanaar.Canvas = function(canvas, callbacks) {
        ...
        function color255(r, g, b, a) {
            var optionalAlpha = void 0 === a ? 1 : a,
                comps = [Math.floor(r), Math.floor(g), Math.floor(b), optionalAlpha];
            return "rgba(" + comps.join() + ")"
        }

        function tracePath(path, offset, s) {
            s = void 0 === s ? 1 : s, offset = offset || {
                x: 0,
                y: 0
            }, ctx.beginPath(), ctx.moveTo(offset.x + s * path[0].x, offset.y + s * path[0].y);
            for (var i = 1, len = path.length; len > i; i++) ctx.lineTo(offset.x + s * path[i].x, offset.y + s * path[i].y);
            return chainable
        }
        var ctx = canvas.getContext("2d"),
            ...
            twopi = 6.2832;
        callbacks && (canvas.addEventListener("mousedown", function(event) {
            callbacks.mousedown && callbacks.mousedown(mouseEventToPos(event))
        }), canvas.addEventListener("mouseup", function(event) {
            callbacks.mouseup && callbacks.mouseup(mouseEventToPos(event))
        }), canvas.addEventListener("mousemove", function(event) {
            mousePos = mouseEventToPos(event), callbacks.mousemove && callbacks.mousemove(mouseEventToPos(event))
        }));
        var chainable = {
            stroke: function() {
                return ctx.stroke(), chainable
            },
            fill: function() {
                return ctx.fill(), chainable
            }
        };
        return {
            mousePos: function() {
            ...
            background: function(r, g, b) {
                ctx.fillStyle = color255(r, g, b), ctx.fillRect(0, 0, canvas.width, canvas.height)
            },
            clear: function() {
                ctx.clearRect(0, 0, canvas.width, canvas.height)
            },
            circle: function(x, y, r) {
                return ctx.beginPath(), 2 === arguments.length ? ctx.arc(x.x, x.y, y, 0, twopi) : ctx.arc(x, y, r, 0, twopi), chainable
            },
            ellipse: function(center, rx, ry, start, stop) {
                return void 0 === start && (start = 0), void 0 === stop && (stop = twopi), ctx.beginPath(), ctx.save(), ctx.translate(center.x, center.y), ctx.scale(1, ry / rx), ctx.arc(0, 0, rx / 2, start, stop), ctx.restore(), chainable
            },
            arc: function(x, y, r, start, stop) {
                return ctx.beginPath(), ctx.moveTo(x, y), ctx.arc(x, y, r, start, stop), chainable
            },
            roundRect: function(x, y, w, h, r) {
                return ctx.beginPath(), ctx.moveTo(x + r, y), ctx.arcTo(x + w, y, x + w, y + r, r), ctx.lineTo(x + w, y + h - r), ctx.arcTo(x + w, y + h, x + w - r, y + h, r), ctx.lineTo(x + r, y + h), ctx.arcTo(x, y + h, x, y + h - r, r), ctx.lineTo(x, y + r), ctx.arcTo(x, y, x + r, y, r), ctx.closePath(), chainable
            },
            rect: function(x, y, w, h) {
                return ctx.beginPath(), ctx.moveTo(x, y), ctx.lineTo(x + w, y), ctx.lineTo(x + w, y + h), ctx.lineTo(x, y + h), ctx.closePath(), chainable
            },
            path: tracePath,
            circuit: function(path, offset, s) {
                return tracePath(path, offset, s), ctx.closePath(), chainable
            },
            ...
            radialGradient: function(x, y, r1, r2, colors) {
                ...
                for (var key in colors) colors.hasOwnProperty(key) && grad.addColorStop(key, colors[key]);
                return grad
            }
        }
    };
    ...
    skanaar.sum = function(list, plucker) {
        for (var transform = {
                ...
                "function": plucker
            }[typeof plucker], i = 0, summation = 0, len = list.length; len > i; i++) summation += transform(list[i]);
        return summation
    }, skanaar.hasSubstring = function(haystack, needle) {
        return "" === needle ? !0 : haystack ? -1 !== haystack.indexOf(needle) : !1
    }, skanaar.format = function(template) {
                ...
                performAction: function(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
                    ...
                    switch (yystate) {
                        ...
                        case 11:
                            var type = "CLASS",
                                id = $$[$0 - 1][0][0],
                                typeMatch = $$[$0 - 1][0][0].match("<([a-z]*)>(.*)");
                            typeMatch && (type = typeMatch[1].toUpperCase(), id = typeMatch[2].trim()), $$[$0 - 1][0][0] = id, this.$ = {
                                type: type,
                                id: id,
                                parts: $$[$0 - 1]
                            }
                        ...
                        switch (action[0]) {
                            ...
                            case 2:
                                if (len = this.productions_[action[1]][1], yyval.$ = vstack[vstack.length - len], yyval._$ = {
                                    ...
                                    }, ranges && (yyval._$.range = [lstack[lstack.length - (len || 1)].range[0], lstack[lstack.length - 1].range[1]]), r = this.performAction.apply(yyval, [yytext, yyleng, yylineno, this.yy, action[1], vstack, lstack].concat(args)), "undefined" != typeof r) return r;
    ...
    "undefined" != typeof require && "undefined" != typeof exports && (exports.parser = nomnomlCoreParser, exports.Parser = nomnomlCoreParser.Parser, exports.parse = function() {
        return nomnomlCoreParser.parse.apply(nomnomlCoreParser, arguments)
    ...
    nomnoml.parse = function(source) {
        ...
        var isDirective = function(line) {
            ...
            pureDirectives = _.filter(lines, isDirective),
            directives = _.object(pureDirectives.map(function(line) {
                try {
            ...
            pureDiagramCode = _.map(_.pluck(lines, "text"), onlyCompilables).join("\n").trim(),
            ast = nomnoml.transformParseIntoSyntaxTree(nomnoml.intermediateParse(pureDiagramCode));
        return ast.directives = directives, ast
        ...
        function transformCompartment(parts) {
            ...
            _.each(parts, function(p) {
                "string" == typeof p && lines.push(p), p.assoc && (rawClassifiers.push(p.start), rawClassifiers.push(p.end), relations.push({
                    id: relationId++,
                    assoc: p.assoc,
                    ...
                    endLabel: p.endLabel
                })), p.parts && rawClassifiers.push(p)
            });
            var allClassifiers = _.map(rawClassifiers, transformItem),
                noDuplicates = _.map(_.groupBy(allClassifiers, "name"), function(cList) {
        ...
        function transformItem(entity) {
            if ("string" == typeof entity) return entity;
    ...
    nomnoml.Classifier = function(type, name, compartments) {
        ...
        function measureLines(lines, fontWeight) {
            return lines.length ? (measurer.setFont(config, fontWeight), {
        ...
        function layoutCompartment(c, compartmentIndex) {
            ...
            if (c.width = textSize.width, c.height = textSize.height, c.nodes.length || c.relations.length) {
                ...
                var dLayout = runDagre(g),
                    rels = _.indexBy(c.relations, "id"),
                    nodes = _.indexBy(c.nodes, "name");
                dLayout.eachNode(function(u, value) {
                    nodes[u].x = value.x, nodes[u].y = value.y
                ...
                var graph = dLayout.graph(),
                    graphHeight = graph.height ? graph.height + 2 * config.gutter : 0,
                    graphWidth = graph.width ? graph.width + 2 * config.gutter : 0;
                c.width = Math.max(textSize.width, graphWidth) + 2 * config.padding, c.height = textSize.height + graphHeight + config.padding
            }
        }

        function layoutClassifier(clas) {
            _.each(clas.compartments, layoutCompartment), clas.width = _.max(_.pluck(clas.compartments, "width")), clas.height = skanaar.sum(clas.compartments, "height"), "HIDDEN" === clas.type && (clas.width = 0, clas.height = 0), clas.x = clas.width / 2, clas.y = clas.height / 2, _.each(clas.compartments, function(co) {
                co.width = clas.width
            })
        }
        return layoutCompartment(ast), ast
    };
    var nomnoml = nomnoml || {};
    nomnoml.render = function(graphics, config, compartment, setFont) {
        function renderCompartment(compartment, style, level) {
            g.ctx.save(), g.ctx.translate(padding, padding), g.ctx.fillStyle = config.stroke, _.each(compartment.lines, function(text, i) {
                g.ctx.textAlign = style.center ? "center" : "left";
                var x = style.center ? compartment.width / 2 - padding : 0,
                    y = (.5 + (i + .5) * config.leading) * config.fontSize;
                if (g.ctx.fillText(text, x, y), style.underline) {
                    var w = g.ctx.measureText(text).width;
                    y += Math.round(.1 * config.fontSize) + .5, g.ctx.lineWidth = Math.round(config.fontSize / 10), g.path([{
                        x: x - w / 2,
                        y: y
                    }, {
                        x: x + w / 2,
                        y: y
                    }]).stroke(), g.ctx.lineWidth = config.lineWidth
                }
            }), g.ctx.translate(config.gutter, config.gutter), _.each(compartment.relations, function(r) {
        ...
        function renderNode(node, level) {
            var x = Math.round(node.x - node.width / 2),
                ...
                xCenter = x + node.width / 2,
                shade = config.fill[level] || _.last(config.fill);
            if (g.ctx.fillStyle = shade, "NOTE" === node.type) g.circuit([{
                x: x,
                y: y
            }, {
                ...
                g.circle(actorCenter, a).fill().stroke(), g.path([{
                    x: xCenter,
                    y: yp
                }, {
                    x: xCenter,
            ...
            } else if ("USECASE" === node.type) {
                var center = {
                    x: xCenter,
                    y: y + node.height / 2
                };
                g.ellipse(center, node.width, node.height).fill().stroke()
            } else if ("START" === node.type) g.ctx.fillStyle = config.stroke, g.circle(xCenter, y + node.height / 2, node.height / 2.5).fill();
            else if ("END" === node.type) g.circle(xCenter, y + node.height / 2, node.height / 3).fill().stroke(), g.ctx.fillStyle = config.stroke, g.circle(xCenter, y + node.height / 2, node.height / 3 - padding / 2).fill();
            else if ("STATE" === node.type) {
                var stateRadius = Math.min(2 * padding * config.leading, node.height / 2);
                g.roundRect(x, y, node.width, node.height, stateRadius).fill().stroke()
            } else if ("INPUT" === node.type) g.circuit([{
                x: x + padding,
                y: y
            }, {
                x: x + node.width,
            ...
            else if ("CHOICE" === node.type) g.circuit([{
                x: node.x,
                y: y - padding
            }, {
                x: x + node.width + padding,
            ...
            } else if ("SENDER" === node.type) g.circuit([{
                x: x,
                y: y
            }, {
                x: x + node.width - padding,
            ...
            else if ("RECEIVER" === node.type) g.circuit([{
                x: x,
                y: y
            }, {
                x: x + node.width + padding,
            ...
            else if ("DATABASE" === node.type) {
                var cx = xCenter,
                    cy = y - padding / 2,
                    pi = 3.1416;
                g.rect(x, y, node.width, node.height).fill(), g.path([{
                    x: x,
                    y: cy
                }, {
                    x: x,
                    ...
                    x: cx,
                    y: cy
                }, node.width, 1.5 * padding).fill().stroke(), g.ellipse({
                    x: cx,
                    y: cy + node.height
                }, node.width, 1.5 * padding, 0, pi).fill().stroke()
            } else g.rect(x, y, node.width, node.height).fill().stroke();
            var yDivider = "ACTOR" === node.type ? y + 3 * padding / 4 : y;
            _.each(node.compartments, function(part, i) {
                var s = textStyle(node, i);
                if (!s.empty && (g.ctx.save(), g.ctx.translate(x, yDivider), setFont(config, s.bold ? "bold" : "normal", s.italic), renderCompartment(part, s, level + 1), g.ctx.restore(), i + 1 !== node.compartments.length))
                    if (yDivider += part.height, "FRAME" === node.type && 0 === i) {
        ...
        function strokePath(p) {
            if ("rounded" === config.edges) {
                var radius = config.spacing * config.bendSize;
                g.ctx.beginPath(), g.ctx.moveTo(p[0].x, p[0].y);
                for (var i = 1; i < p.length - 1; i++) {
                    var vec = vm.diff(p[i], p[i - 1]),
                        bendStart = vm.add(p[i - 1], vm.mult(vm.normalize(vec), vm.mag(vec) - radius));
                    g.ctx.lineTo(bendStart.x, bendStart.y), g.ctx.arcTo(p[i].x, p[i].y, p[i + 1].x, p[i + 1].y, radius)
                }
                g.ctx.lineTo(_.last(p).x, _.last(p).y), g.ctx.stroke()
            } else g.path(p).stroke()
        }

        function renderRelation(r, compartment) {
            function drawArrowEnd(id, path, end) {
                ">" === id || "<" === id ? drawArrow(path, filled, end) : ":>" === id || "<:" === id ? drawArrow(path, empty, end) : "+" === id ? drawArrow(path, filled, end, diamond) : "o" === id && drawArrow(path, empty, end, diamond)
            }
            var startNode = _.findWhere(compartment.nodes, {
                    name: r.start
                }),
                endNode = _.findWhere(compartment.nodes, {
                    name: r.end
                }),
                start = rectIntersection(r.path[1], _.first(r.path), startNode),
                end = rectIntersection(r.path[r.path.length - 2], _.last(r.path), endNode),
                path = _.flatten([start, _.tail(_.initial(r.path)), end]),
                fontSize = config.fontSize;
            g.ctx.fillStyle = config.stroke, setFont(config, "normal");
            var textW = g.ctx.measureText(r.endLabel).width,
                labelX = "LR" === config.direction ? -padding - textW : padding;
            if (g.ctx.fillText(r.startLabel, start.x + padding, start.y + padding + fontSize), g.ctx.fillText(r.endLabel, end.x + labelX, end.y - padding), "-/-" !== r.assoc)
                if (g.ctx.setLineDash && skanaar.hasSubstring(r.assoc, "--")) {
                    var dash = Math.max(4, 2 * config.lineWidth);
                    g.ctx.setLineDash([dash, dash]), strokePath(path), g.ctx.setLineDash([])
                } else strokePath(path);
            var tokens = r.assoc.split("-");
            drawArrowEnd(_.last(tokens), path, end), drawArrowEnd(_.first(tokens), path.reverse(), start)
        }

        function rectIntersection(p1, p2, rect) {
            if (0 === rect.width && 0 === rect.height) return p2;
            for (var v = vm.diff(p1, p2), t = 1; t >= 0; t -= .01) {
                var p = vm.mult(v, t);
        ...
        function drawArrow(path, isOpen, arrowPoint, diamond) {
            ...
            var size = (config.spacing - 2 * config.edgeMargin) * config.arrowSize / 30,
                v = vm.diff(path[path.length - 2], _.last(path)),
                nv = vm.normalize(v),
                arrowBase = getArrowBase(diamond ? 7 : 10),
                t = vm.rot(nv),
                arrowButt = diamond ? getArrowBase(14) : isOpen && !config.fillArrows ? getArrowBase(5) : arrowBase,
                arrow = [vm.add(arrowBase, vm.mult(t, 4 * size)), arrowButt, vm.add(arrowBase, vm.mult(t, -4 * size)), arrowPoint];
            g.ctx.fillStyle = isOpen ? config.stroke : config.fill[0], g.circuit(arrow).fill().stroke()
        }

        function snapToPixels() {
            config.lineWidth % 2 === 1 && g.ctx.translate(.5, .5)
        }
        var padding = config.padding,
            ...
            filled = !0,
            diamond = !0;
        g.clear(), setFont(config, "bold"), g.ctx.save(), g.ctx.lineWidth = config.lineWidth, g.ctx.lineJoin = "round", g.ctx.lineCap = "round", g.ctx.strokeStyle = config.stroke, g.ctx.scale(config.zoom, config.zoom), snapToPixels(), renderCompartment(compartment, {}, 0), g.ctx.restore()
    };
    var nomnoml = nomnoml || {};
    return function() {
        "use strict";
        ...
        function getConfig(d) {
            return {
                ...
                fill: (d.fill || "#3aceff;#3aceff;#3aceff;#3aceff").split(";"),
                fillArrows: "true" === d.fillArrows,
                font: d.font || "Calibri",
        ...
        function fitCanvasSize(canvas, rect, zoom, superSampling) {
            var w = rect.width * zoom,
                h = rect.height * zoom;
            canvas.width = w * superSampling, canvas.height = h * superSampling
        }

        function setFont(config, isBold, isItalic, graphics) {
            var style = "bold" === isBold ? "bold" : "";
            isItalic && (style = "italic" + style);
            var defaultFont = "Helvetica, sans-serif",
                font = skanaar.format("# #pt #, #", style, config.fontSize, config.font, defaultFont);
            graphics.ctx.font = font
        }

        function parseAndRender(code, graphics, canvas, superSampling, scale) {
            var ast = nomnoml.parse(code),
                config = getConfig(ast.directives),
                measurer = {
                ...
                layout = nomnoml.layout(measurer, config, ast);
            return fitCanvasSize(canvas, layout, config.zoom * scale, superSampling), config.zoom *= superSampling, config.zoom *= scale, nomnoml.render(graphics, config, layout, measurer.setFont), {
                config: config,
