...
! function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('Mostrar %s filas por página', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
          //return sprintf('Mostrando %s a %s de un total de  %s filas', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initTable = function () {
        ...
        this.$el.find('tbody tr').each(function () {
            ...
            $(this).find('td').each(function (i) {
                ...
                row['_' + field + '_style'] = $(this).attr('style');
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            html.push('<tr',
                ...
                sprintf(' style="%s"', $.isArray(item) ? undefined : item._style),
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (item['_' + field + '_style']) {
                    id_ = sprintf(' style="%s"', item['_' + field + '_style']);
                }
    ...
    BootstrapTable.prototype.destroy = function () { console.log(this.$el);
    ...
    $(window).resize(function () {
      $('.tabla-fresh').bootstrapTable('resetView');
    });
