    ...
    e.addCommand("mcePreview", function() {
        e.windowManager.open({
            ...
            onPostRender: function() {
                var r, i = "";
                i += '<base href="' + e.documentBaseURI.getURI() + '">',
                ...
                o.indexOf("=") != -1 && (o = e.getParam("body_id", "", "hash"),
                o = o[e.id] || o);
                var a = t.body_class || "";
                a.indexOf("=") != -1 && (a = e.getParam("body_class", "", "hash"),
                a = a[e.id] || "");
                ...
                if (r = "<!DOCTYPE html><html><head>" + i + '</head><body id="' + o + '" class="mce-content-body ' + a + '"' + l + ">" + e.getContent() + s + "</body></html>",
                n)
