tinymce.PluginManager.add("charmap", function(e) {
    ...
    function i(t) {
        var n = e.settings;
        return n.charmap && (t = r(n.charmap)),
        n.charmap_append ? [].concat(t).concat(r(n.charmap_append)) : t
    }
    function o() {
        return i(t())
    }
    ...
    function s() {
        ...
        for (i = 0; i < u; i++) {
            ...
            r = 0; r < c; r++) {
                ...
                if (d < l.length) {
                    var f = l[d];
                    n += '<td title="' + f[1] + '"><div tabindex="-1" title="' + f[1] + '" role="button">' + (f ? String.fromCharCode(parseInt(f[0], 10)) : "&nbsp;") + "</div></td>"
                } else
                    n += "<td />"
            }
            n += "</tr>"
        ...
        var h = {
            ...
            onclick: function(e) {
                var n = e.target;
                /^(TD|DIV)$/.test(n.nodeName) && t(n).firstChild && (a(tinymce.trim(n.innerText || n.textContent)),
                e.ctrlKey || s.close())
            },
            onmouseover: function(e) {
                var n = t(e.target);
                n && n.firstChild ? (s.find("#preview").text(n.firstChild.firstChild.data),
                s.find("#previewTitle").text(n.title)) : (s.find("#preview").text(" "),
    ...
    return e.addCommand("mceShowCharmap", s),
    e.addButton("charmap", {
        icon: "charmap",
