tinymce.PluginManager.add("autolink", function(e) {
    ...
    function i(e, t, n) {
        ...
        if ("A" != e.selection.getNode().tagName) {
            if (s = e.selection.getRng(!0).cloneRange(),
            s.startOffset < 5) {
                ...
                if (u = s.endContainer,
                3 != u.nodeType && u.firstChild) {
                    for (; 3 != u.nodeType && u.firstChild; )
                        u = u.firstChild;
                    3 == u.nodeType && (i(u, 0),
                    o(u, u.nodeValue.length))
                }
            ...
            do
                ...
                l -= 1,
                g = s.toString();
            while (" " != g && "" !== g && 160 != g.charCodeAt(0) && l - 2 >= 0 && g != n);s.toString() == n || 160 == s.toString().charCodeAt(0) ? (i(u, l),
            o(u, c),
            l += 1) : 0 === s.startOffset ? (i(u, 0),
            o(u, c)) : (i(u, l),
            o(u, c)),
            f = s.toString(),
            "." == f.charAt(f.length - 1) && o(u, c - 1),
            f = s.toString(),
            h = f.match(a),
            h && ("www." == h[1] ? h[1] = "http://www." : /@$/.test(h[1]) && !/^mailto:/.test(h[1]) && (h[1] = "mailto:" + h[1]),
    ...
    return e.settings.autolink_pattern && (a = e.settings.autolink_pattern),
