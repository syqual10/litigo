	...
	<div class="row" style="margin-bottom: 15px;" >
		<div class="form-wrap">
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" data-mask="9999-99999" id="radicadoJuzgado"  name="param" placeholder="Radicado del juzgado" class="form-control" value="{{$proceso[0]->radicadoJuzgado}}">
				</div>
			</div>
		</div>
	</div>
