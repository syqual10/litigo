          ...
          <div class="grid profile">
            <div class="grid-header grid-header-blue">
              ...
              <div class="col-xs-5 text-right">
                <a href="{{ asset('mis-procesos/index/1/'.$proceso[0]->juritipoprocesos_idTipoProceso.'/'.$idResponsable)}}" class="btn btn-success">
                ...
                @if($responsable == 1)
                  ...
                  <button class="btn btn-primary btn-guardar-dependencia" onclick="modalAsociarProceso({{$proceso[0]->vigenciaRadicado}} ,{{$proceso[0]->idRadicado}});">
                    <i class="fa fa-plus"></i> <a id="eventUrl" style="color:#fff; text-decoration:none;"> Asociar proceso judicial </a>
                  </button>
                                        ...
                                        <table id="tableReport" class="table table-hover table-striped ">
                                          <tbody>
                                            ...
                                            <tr class="media" data-id="30">
                                              ...
                                              <td class="media-body">
                                                <span>Juzgado:<h4>{{$proceso[0]->nombreJuzgado}}</h4></span>
                                              </td>
                                            </tr>
                                            @if(count($agendas) > 0)
                                              <tr class="media" data-id="30">
                                ...
                                <div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3" aria-expanded="false">
                                  <div class="panel-body">
                                    @if($responsable == 1)
                                      <div class="row" style="padding-left:20px">
                                        <div class="col-sm-12">
                                          <button class="btn btn-xs btn-primary btn-rounded" onclick="nuevaDependenciaProceso(3)"><i class="fa fa-save"></i> Agregar Dependencia Afectada</button>
                                        </div>
                                      </div>
                                    @endif
                                    <div id="resultadoDemandados"></div>
                                  </div>
                                </div>
                              </div>
                              <!-- #Dependencia Afectada -->
                                ...
                                <div id="collapse7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading7" aria-expanded="false">
                                  <div class="panel-body">
                                    @if($responsable == 1)
                                      <div class="row" style="padding-left:20px">
                                        <div class="col-sm-12">
                                          <button class="btn btn-xs btn-primary btn-rounded" onclick="nuevoExterno(6)"><i class="fa fa-save"></i> Agregar Entidad Externa</button>
                                        </div>
                                      </div>
                                    @endif
