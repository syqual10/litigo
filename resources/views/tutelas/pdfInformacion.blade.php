    ...
    <table id="encabezado" border="0">
        <tr>
            <td width="20%" rowspan="4">
                <!--<img src="documentos/entidad/logo.png" width="120"> -->           
            </td>        
                    ...
                    <table width="100%">
                        ...
                        <tbody>
                            @foreach($accionadosExt as $accionadoExt)
                                <tr>
                                    <td width="90%">{{$accionadoExt->nombreConvocadoExterno}}</td>
                                    <td width="90%">{{$accionadoExt->direccionConvocadoExterno}}</td>
                                    <td width="90%">{{$accionadoExt->telefonoConvocadoExterno}}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
