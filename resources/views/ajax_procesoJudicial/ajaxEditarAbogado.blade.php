...
<div class="modal-footer">
  ...
  <button class="btn btn-success btn-editar-abogado"><i class="icon-rocket"></i> <a id="eventUrl" style="color:#fff; text-decoration:none;" onclick="validarEditarAbogado({{$abogado[0]->idAbogado}});">Modificar</a></button>
</div>