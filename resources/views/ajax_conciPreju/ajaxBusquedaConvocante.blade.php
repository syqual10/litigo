...
@if(count($solicitantes) > 0)
	@if(count($solicitantes) == 1)
		<h1 class="font-md"> Resultado de la búsqueda para <span class="semi-bold">{{$criterioConvocante}}</span>
	...
	@foreach($solicitantes as $solicitante)
		<div class="search-results clearfix smart-form">
			<h4><i class="fa fa-plus-square txt-color-blue"></i>&nbsp;<a href="javascript:void(0);" onclick="seleccioneConvocante('{{$solicitante->idSolicitante}}');">{{$solicitante->nombreSolicitante}}</a></h4>
			<div>
