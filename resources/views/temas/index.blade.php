...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Inicio</li><li>Configuración</li><li>Temas</li>
    </ol>
    <!-- end breadcrumb -->
</div>
<!-- END RIBBON -->
        ...
        <div class="row">
            ...
            <article class="col-sm-12">
                <div class="jarviswidget jarviswidget-color-blue" role="widget">                    
                    <header role="heading">
                        <h2>Administración <strong><i>de Temas</i></strong></h2>  
                    </header>
                    <!-- widget div-->
                    <div role="content">
                        <!-- widget content -->
                        <div class="widget-body">                                
                            <div id="resultadoTablaTemas" class="cont-ajax">
                                <!-- ajax -->
                            </div>
                        </div>
                        <!-- end widget content -->
...
@endsection
@section('scriptsFin')
    <script src="{{asset('js/js_temas/adminTemas.js')}}"></script>
